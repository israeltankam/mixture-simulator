...
if main_tab == "Edit varieties":
    ...
    with col1:
        ...
        st.session_state.alpha_A= st.slider("Acquisition rate A", min_value=0.0, max_value=0.1, value=st.session_state.alpha_A, step=0.001)
        st.session_state.beta_A= st.slider("Inoculation rate A", min_value=0.0, max_value=0.1, value=st.session_state.beta_A, step=0.001)
    ...
    with col2:
        ...
        st.session_state.alpha_B= st.slider("Acquisition rate B", min_value=0.0, max_value=0.1, value=st.session_state.alpha_B, step=0.001)
        st.session_state.beta_B= st.slider("Inoculation rate B", min_value=0.0, max_value=0.1, value=st.session_state.beta_B, step=0.001)
